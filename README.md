...
WARNING: although the client allows you to install Google Play Services, these are just vanilla non-sandboxed play services, as sandboxing would require the Sandboxes Google Play compatibility layer (GmsCompat), which is part of the GrapheneOS system
